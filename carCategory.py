...
#返回奥迪官网二手车的所有车型以及具体信息的url
def carCategory():
    audiUrl = "https://carsearch.audi.cn/usedcar/url-1_1-list.htm#/i/s|10,AACO,AACV/l|12,2,STAT_GWPLUS,U"
    response = requests.get(audiUrl,headers=header)
    ...
    print(audiModels)
    print(audiModelsUrl)
    return audiModels,audiModelsUrl
